...
/**
 ...
 App Store edition's carry different names for the same reason their entry
 points do: identically named ones would share a USR, and the dead-code check
 reads a single index built from both.
 */
struct ZephyrDownloadIntentsPackage: AppIntentsPackage {
 ...
 */
struct ZephyrDownloadShortcuts: AppShortcutsProvider {
